...
ALTER TABLE app_user DROP CONSTRAINT chk_app_user_status;
ALTER TABLE app_user ADD CONSTRAINT chk_app_user_status
    CHECK (status IN ('ACTIVE', 'INACTIVE', 'PENDING'));

-- password_token · un enlace de un solo uso vale por una fila.
--
...
-- inmutabilidad que llevan esas dos: no es un ledger histórico, es estado
